...
var context = require('rabbit.js').createContext(
    'amqp://producer:PrOdUcInG@producer.mit.edu:5672/producer' // URL
);

var port = process.argv[2] || 8888;

var privateKey = fs.readFileSync('/etc/httpd/conf/ssl.key/producer.mit.edu.key').toString();
var certificate = fs.readFileSync('/etc/httpd/conf/ssl.crt/producer.mit.edu.crt').toString();
