...
OKI_DEV_HANDCAR_APP_KEY = settings_credentials.__dict__.get('OKI_DEV_HANDCAR_APP_KEY')
SEI_DEV_HANDCAR_APP_KEY = settings_credentials.__dict__.get('SEI_DEV_HANDCAR_APP_KEY')
