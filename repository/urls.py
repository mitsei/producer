...
urlpatterns = patterns('',
    ...
    url(r'^assets/(?P<asset_id>[-.:@%\d\w]+)/objectives/?$',
        views.AssetObjectives.as_view()),
    url(r'^compositions/?$',
        views.CompositionsList.as_view()),
    ...
    url(r'^compositions/(?P<composition_id>[-.:@%\d\w]+)/objectives/?$',
        views.CompositionObjectives.as_view()),
